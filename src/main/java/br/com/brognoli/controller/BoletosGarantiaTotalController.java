...
public class BoletosGarantiaTotalController {
	...
	private String caminhoDir= "d:\\garantia\\boletos\\";
	//"\\\\arqsrv02\\documentos\\centralfinanceira\\BOLETOS DE CONDOMÍNIOS\\Winker\\";
	...
	@ResponseStatus(HttpStatus.CREATED)
	public ResponseEntity<Void> exportarExcel() {
		File fileDir = new File(caminhoDir);
		int encontrado = 0;
		String arquivos[] = fileDir.list();
		...
		for (int i=0;i<arquivos.length;i++) {
			...
			String fileName = "";
			File file = null;
			fileName = caminhoDir + arquivos[i];
			file = new File(fileName);
			codigoImovel = getCodgioImovel(file.getName());
			gPDF =true;
			...
			if (modelo !=null) {
				...
				if (modelo.getModelo().equalsIgnoreCase("Resumo de rateio")) {
					...
					try {
						boleto.setListaResumo(modeloDuplique.gerarTXT(fileName));
					} catch (IOException e) {
						// TODO Auto-generated catch block
						e.printStackTrace();
					}
					...
					try {
						boleto.setListaResumo(modeloExato.gerarTXT(fileName));
					} catch (IOException e) {
						// TODO Auto-generated catch block
						e.printStackTrace();
					}
					...
					try {
						boleto.setListaResumo(modeloPontual.gerarTXT(fileName));
					} catch (IOException e) {
						// TODO Auto-generated catch block
						e.printStackTrace();
					}
					...
					try {
						boleto.setListaResumo(modeloCNeto.gerarTXT(fileName));
					} catch (IOException e) {
						// TODO Auto-generated catch block
						e.printStackTrace();
					}
					...
					try {
						boleto.setListaResumo(modeloDuplic2.gerarTXT(fileName));
					} catch (IOException e) {
						// TODO Auto-generated catch block
						e.printStackTrace();
					}
					...
					try {
						boleto.setListaResumo(modeloMaxima.gerarTXT(fileName));
					} catch (IOException e) {
						// TODO Auto-generated catch block
						e.printStackTrace();
					}
					...
					try {
						boleto.setListaResumo(modeloFeltrin.gerarTXT(fileName));
					} catch (IOException e) {
						// TODO Auto-generated catch block
						e.printStackTrace();
					}
					...
					try {
						boleto.setListaResumo(modeloBRCONDOS.gerarTXT(fileName));
					} catch (IOException e) {
						// TODO Auto-generated catch block
						e.printStackTrace();
					}
					...
					try {
						boleto.setListaResumo(modeloControll.gerarTXT(fileName));
					} catch (IOException e) {
						// TODO Auto-generated catch block
						e.printStackTrace();
					}
					...
					try {
						boleto.setListaResumo(modeloDuo.gerarTXT(fileName));
					} catch (IOException e) {
						// TODO Auto-generated catch block
						e.printStackTrace();
					}
					...
					try {
						boleto.setListaResumo(modeloFama.gerarTXT(fileName));
					} catch (IOException e) {
						// TODO Auto-generated catch block
						e.printStackTrace();
					}
					...
					try {
						boleto.setListaResumo(modeloGi.gerarTXT(fileName));
					} catch (IOException e) {
						// TODO Auto-generated catch block
						e.printStackTrace();
					}
