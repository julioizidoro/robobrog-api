...
public class RegraCondominio {
	...
	public Modelos retornaModelo(Modelos modelo, String condominio) {
		...
		if (modelo.getAdministradora().equalsIgnoreCase("Adcon SC")) {
			modelo.setModelo("ModeloAdeconSC");
		}
		
		if (modelo.getAdministradora().equalsIgnoreCase("Aliança - Gestão e Adm de Condomínios")) {
			modelo.setModelo("ModeloAdeconSC");
		}
		...
		if (modelo.getAdministradora().equalsIgnoreCase("Grupo Embracon")) {
			if (condominio.equalsIgnoreCase("CONJUNTO MARIA ZITA")) {
				...
				modelo.setModelo("ModeloGrupoEmbraconCodigoBarras");
			}else if (condominio.equalsIgnoreCase("SPAZZIO DONATELLO")) {
				modelo.setModelo("ModeloGrupoEmbraconCodigoBarras");
				...
				modelo.setModelo("ModeloGrupoEmbraconCodigoBarras");
			} else if (condominio.equalsIgnoreCase("AMPIEZZA")) {
				modelo.setModelo("ModeloGrupoEmbraconCodigoBarras");
			}else if (condominio.equalsIgnoreCase("D ONE HOME DESIGN")) {
				modelo.setModelo("ModeloGrupoEmbraconCodigoBarras");
			} else if (condominio.equalsIgnoreCase("PARQUE ILHA DO ARVOREDO")) {
				modelo.setModelo("ModeloGrupoEmbraconCodigoBarras");
			} else if (condominio.equalsIgnoreCase("VERONA")) {
				modelo.setModelo("ModeloGrupoEmbraconCodigoBarras");
			} else if (condominio.equalsIgnoreCase("PREMIUM RESIDENCE")) {
				modelo.setModelo("ModeloGrupoEmbraconCodigoBarras");
			} else if (condominio.equalsIgnoreCase("VIVAZ CONDOMÍNIO JARDIM")) {
				modelo.setModelo("ModeloAdeconSC");
				...
				modelo.setModelo("Resumo Grupo Embracon");
			}else if (condominio.equalsIgnoreCase("BLUEBELL STUDIO RESIDENCE")) {
				modelo.setModelo("ResumoGrupoEmbraconAdministradora");
			}else if (condominio.equalsIgnoreCase("PORTO DE CASSIS")) {
				modelo.setModelo("ResumoGrupoEmbraconAdministradora");
			}else if (condominio.equalsIgnoreCase("MULTI OPEN SHOPPING E OFFICES")) {
				modelo.setModelo("ResumoGrupoEmbraconAdministradora");
			}else if (condominio.equalsIgnoreCase("MILLENIUM PALACE")) {
				modelo.setModelo("ResumoGrupoEmbraconAdministradora");
			}else if (condominio.equalsIgnoreCase("ILHA DE MURANO")) {
				modelo.setModelo("ResumoGrupoEmbraconAdministradora");
			}else if (condominio.equalsIgnoreCase("ILHA DE MURANO")) {
				modelo.setModelo("RESIDENCIAL HAMURABI");
			}else if (condominio.equalsIgnoreCase("ILHA DE MURANO")) {
				modelo.setModelo("MOSELLE");
			} else if (condominio.equalsIgnoreCase("ILHA DE MURANO")) {
				modelo.setModelo("MOSELLE");
			}else if (condominio.equalsIgnoreCase("RESIDENCIAL PRISCILA")) {
				modelo.setModelo("MOSELLE");
			}else if (condominio.equalsIgnoreCase("RESIDENCIAL RECANTO DOS POETAS")) {
				modelo.setModelo("MOSELLE");
			}
